#
# This started life as the pydmm module by Michael Weigend
#
# TODO this
# My meter has a weird issue with mA readings in that they contain a decimal point AND a 'micro' which produces a WAY too-small result
# I've therefore hacked this to NOT do that...
# 
...
def _get_number(d):
    ...
    elif d[10][4] == "1": n /= 1000    #Milli - this is a problem for Ma range as it ALSO shows a DP so values are WAY off
